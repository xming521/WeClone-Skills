...
- `digital-legacy-memorial-reply`：身后数字遗产场景，模拟家属或授权管理者在纪念账号、旧联系方式中体面处理必要留言和授权沟通。
...
- `digital-legacy-memorial-reply`：digital legacy scenario for family-managed memorial accounts and necessary follow-up communication.
